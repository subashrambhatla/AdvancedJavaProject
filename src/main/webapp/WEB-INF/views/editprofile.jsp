			 ...
			 <div ng-app="quiz-manager" ng-controller="Studentregstration">
				<form name="myform" ng-submit="submitStudentForm()">
					...
					<div class="form-group">
						...
						<input id="lastname" name="rollNo" class="form-control" type="text" data-validation="email" ng-model="Studentreg.rollNo" readonly="readonly">
						<span id="error_lastname" class="text-danger"></span>
					</div>
					<div class="form-group">
						<label for="age">Age *</label>
						<input id="age" name="age"  class="form-control" type="text"  ng-model="Studentreg.age">
						<span id="error_age" class="text-danger"></span>
					</div>
					<div class="form-group">
						<label for="dob">Date Of Birth *</label>
						<input  name="dob" id="dob" class="form-control"  ng-model="Studentreg.dob">
